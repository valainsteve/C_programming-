...
int main()
{
    ...
    /*wenn die erste Bedingung nicht erfüllt ist, dann
    wird die zweite gar nicht mehr geprüft*/
    if( a > b && istCGroesserD(c,d))
    {
        printf("a ist goesser als b und c ist groesser als d");

    }else {
        printf("a ist nicht goesser als b oder c ist nicht groesser als d");
    }
